...
const RpcMenu = () => {
  ...
  return (
    <DropdownMenuSub onOpenChange={onOpenChange}>
      <DropdownMenuSubTriggerLeft className="w-full h-12 flex items-center justify-between rounded-lg pl-3.5 pr-2 py-2 text-black hover:bg-main-700 hover:text-[#ccc]">
      ...
      <DropdownMenuSubContent
        sideOffset={8}
        alignOffset={8}
        className="relative w-44 bg-[linear-gradient(226deg,#93FE0D_0%,#FFFF00_100%)] border-none"
      >
        <div
        ...
        {rpcNodes.map((rpcNode, idx) => (
          ...
          >
            <button
              className={`w-full flex items-center justify-between rounded-lg px-1 py-1 text-black hover:bg-main-700 hover:text-[#000] ${
